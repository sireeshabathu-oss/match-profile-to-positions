...
def build_final_matches(
    ...
    for position in position_data.get("positions", []):
        ...
        matching_preferred = (
            candidate_skills & preferred_normalized
        )

        missing_required = (
            required_normalized - candidate_skills
        )
        ...
        matches.append(
            {
                ...
                "matching_preferred_skills": sorted(
                    matching_preferred
                ),
                "candidate_years": candidate_years,
                "required_years": required_years,
...
if __name__ == "__main__":
    ...
    for match in final_matches:
        ...
        print(
            ...
            ", ".join(
                match["matching_required_skills"]
            ) or "None",
        )
        ...
        print(
            ...
            ", ".join(
                match["matching_preferred_skills"]
            ) or "None",
        )

        print(
            f"Experience: "
            f"{match['candidate_years']} years "
            f"(required: "
            f"{match['required_years']} years)"
        )
